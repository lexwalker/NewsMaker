...
_TRANSPORT_NEG_GATES = (
    ...
    # military PERSONNEL (v47 audit: «проверки военных на опьянение»
    # matched опьянени but is about servicemen, not drivers).
    "военных", "военнослужащ", "военные", "военным", "срочник",
    "мобилиз", "военкомат", "призывник",

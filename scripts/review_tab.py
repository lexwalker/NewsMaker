...
INSTRUCTIONS = (
    "ИИ просит проверить. Ответ — ЦВЕТОМ ячейки D, как в ленте: зелёная = "
    "новость нужна, красная = не нужна (текст «да»/«нет» тоже работает; "
    "текст главнее цвета). Если нужна — по возможности впишите раздел в E. "
    "Тип (C): «отклонил» — ИИ это отклонил; «дубль»/«не новость» — ИИ бы "
    "опубликовал, но засомневался. Это учит ИИ на ваших решениях."
)
